...
def test_get_recipes():
    ...
    def mock_recipe_service():
        ...
        mock_recipes = [
            ...
            Recipe(id=2, user_id=1, name="Chicken Curry", prep_time_sec=900, cook_time_sec=1800),
...
def test_create_recipe_minimal_fields():
...
def test_create_recipe_conflict():
...
def test_update_recipe_conflict():
