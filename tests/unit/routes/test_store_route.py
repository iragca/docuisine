...
class TestRegularUser:
    ...
    def test_create_store_success(self, app_regular_user: MagicMock):
    ...
    def test_create_store_minimal_fields(self, app_regular_user: MagicMock):
    ...
    def test_create_store_conflict(self, app_regular_user: MagicMock):
    ...
    def test_update_store_success(self, app_regular_user: MagicMock):
    ...
    def test_update_store_partial(self, app_regular_user: MagicMock):
    ...
    def test_update_store_not_found(self, app_regular_user: MagicMock):
    ...
    def test_update_store_conflict(self, app_regular_user: MagicMock):
    ...
    def test_delete_store_success(self, app_regular_user: MagicMock):
    ...
    def test_delete_store_not_found(self, app_regular_user: MagicMock):
